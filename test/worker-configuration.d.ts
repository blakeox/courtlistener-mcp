/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.mcp.test.jsonc --env-interface=MpcTestEnv test/worker-configuration.d.ts` (hash: 5c9ede828cfbd833c2577290174c4a86)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_BOUNDARY_FAIL_OPEN" | "CODEMODE_ENABLED">> {}
}
