/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.mcp.test.jsonc --env-interface=MpcTestEnv test/worker-configuration.d.ts` (hash: 5653fd171332057df3466862fa385db3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_BOUNDARY_FAIL_OPEN" | "CODEMODE_ENABLED" | "MCP_ASYNC_QUEUE_ENABLED">> {}
}
