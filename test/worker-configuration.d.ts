/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.mcp.test.jsonc --env-interface=MpcTestEnv test/worker-configuration.d.ts` (hash: 78740206ba456a04a50ef9c5b9e5faa2)
// Runtime types generated with workerd@1.20260730.1 2026-03-02 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_MpcTestEnv {
  ...
  MCP_OBJECT: DurableObjectNamespace<import('../src/worker-mcp').CourtListenerMCP>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('../src/worker-mcp');
    durableNamespaces: 'CourtListenerMCP';
  }
  interface Env extends __BaseEnv_MpcTestEnv {}
}
interface MpcTestEnv extends __BaseEnv_MpcTestEnv {}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      | 'MCP_OAUTH_BACKEND'
      | 'MCP_ALLOW_DEV_FALLBACK'
      | 'MCP_SESSION_LIFECYCLE_FAIL_OPEN'
