/**
 * @deprecated This module is superseded by `common/errors.ts` which provides
 * the unified error hierarchy for the entire application. Use `common/errors.ts`
 * for all new code. This file will be removed in a future version.
 *
 * Legacy Advanced Error Handling System for Legal MCP Server
